...
/**
 * Problem formulation in: <a href="https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/?envType=study-plan-v2&envId=top-interview-150">...</a>
 */
public class RemoveDuplicatesPartTwoTests {
    ...
    private static Stream<Arguments> source() {
        return Stream.of(
                ...
                Arguments.of(new int[]{1, 1, 2, 2}, new int[]{1, 1, 2, 2}),
                Arguments.of(new int[]{1, 1, 1, 2, 2}, new int[]{1, 1, 2, 2}),
    ...
    public int removeDuplicates(int[] nums) {
        ...
        while (duplicateIndex != nums.length
            ...
            if (nums[duplicateIndex] > maxNumber) {
                ...
                uniqueIndex++;
            } else if (nums[duplicateIndex] == maxNumber && maxNumberOccurences == 1) {
                maxNumberOccurences++;
                nums[uniqueIndex] = maxNumber;
                uniqueIndex++;
            }
